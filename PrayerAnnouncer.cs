...
namespace Personal_Assistant.PrayerTimesCalculator
{
    ...
    public sealed class PrayerAnnouncer
    {
        ...
        // Every line this can ever say.
        //
        // On main this feeds --render-clips, which pre-renders each line in the
        // Live voice. This branch synthesises everything through Kokoro on demand
        // and has no clip cache, so nothing consumes this yet — it is kept so the
        // two branches' announcement wording stays comparable, and because a list
        // of everything a feature can say is worth having regardless.
