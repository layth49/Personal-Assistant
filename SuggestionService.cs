...
namespace Personal_Assistant.Suggestions
{
    ...
    public sealed class SuggestionService
    {
        ...
        // The offer waiting for an answer. On this branch the offer is also
        // recorded in ConversationMemory, which the dispatcher passes to the model
        // as history — so "yeah, go on" resolves without any extra plumbing.
