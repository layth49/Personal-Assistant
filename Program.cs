            ...
            registry.Add(new VoiceCommand(
                ...
                async (ctx, args) =>
                {
                    ...
                    try
                    {
                        ...
                        string answer = await GeminiService.AskAboutImageAsync(question, png);
                        return string.IsNullOrWhiteSpace(answer)
                            ? ToolResult.Failed("Sorry, I couldn't make sense of what's on screen.")
                            : ToolResult.Speak(answer)
                                .With("answer", answer)
            ...
            registry.Add(new VoiceCommand(
                ...
                async (ctx, args) =>
                {
                    ...
                    try
                    {
                        ...
                        string text = await GeminiService.AskAboutImageAsync(prompt, png);
                        ...
                        // can still reason about it if asked a follow-up.
            ...
            registry.Add(new VoiceCommand(
                ...
                async (ctx, args) =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            string answer = await GeminiService.TransformTextAsync(
                        ...
                        return ToolResult.Speak(
                                content.Trim().Length == 0
                                    ...
                                    : $"Your {target.Name} note says: {content.Trim()}")
                            .With("note", target.Name)
            ...
            registry.Add(new VoiceCommand(
                ...
                async (ctx, args) =>
                {
                    ...
                    try
                    {
                        ...
                        string after = await GeminiService.TransformTextAsync(
