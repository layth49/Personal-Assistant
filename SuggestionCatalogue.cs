            ...
            return new Suggestion(
                ...
                accept: async () =>
                {
                    ...
                    await runTool("set_alarm",
                        new Dictionary<string, string> { ["time"] = alarmTime, ["label"] = "Fajr" },
            ...
            return new Suggestion(
                ...
                accept: async () =>
                {
                    await runTool("control_volume",
                        new Dictionary<string, string> { ["action"] = "set", ["level"] = "30" },
                        false).ConfigureAwait(false);
            ...
            return new Suggestion(
                ...
                accept: async () =>
                {
                    await runTool("set_trigger",
                        new Dictionary<string, string>(idea), false).ConfigureAwait(false);
